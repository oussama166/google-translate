...
const Translate = () => {
    ...
    const [getTranslate, setGetTranslate] = useState({ "text": "...", "from": "en", "to": "es" })
    const [isDone, setIsDone] = useState(false)

    const [getLang, SetLang] = useState({ "from": "en", "to": "es" })
        ...
        <div className='w-full h-screen bg-slate-50 flex flex-col z-[1] '>
            <div
                ...
                >
                    ...
                    >
                        <TextTranslate isDisable={false} isDone={setIsDone} takeText={setGetTranslate} translateFiled={false} />
                        <TextTranslate isDisable={true} output={backendData[0]} translateFiled={true} />
                    </div>
                </form>
            </div>
        </div>
