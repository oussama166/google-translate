        ...
        <div className='w-full h-screen bg-slate-50 flex flex-col z-[1]'>
            <div className='w-full max-h-72 h-1/2 flex flex-col justify-start items-center bg-blue-500 py-10'>
                ...
                >
                    ...
                    <input
                        className="placeholder:italic placeholder:text-slate-400 block  w-full border text-slate-400 border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"
