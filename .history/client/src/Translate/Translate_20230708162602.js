...
const Translate = () => {
    ...
    return (
        <div className='w-full h-screen bg-slate-50 flex flex-col z-[1]'>
            <div className='w-full max-h-72 h-1/2 flex flex-col justify-start items-center bg-blue-500 py-10 absolute'>
                {/* THIS BAR OF LANG */}
            ...
            <div>
                <textarea cols="30" rows="10" aria-controls='false'></textarea>
            </div>
        </div>
    )
}
