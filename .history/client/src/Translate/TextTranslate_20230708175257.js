...
const TextTranslate = ({ isDisable }) => {
    return (
        <div
            ...
            {/* Bottom bar */}
            <div className='inline-flex items-center justify-between gap-5 bg-transparent absolute bottom-0 left-0 w-full h-14 px-6 box-shadow-top'>

                <div className="inline-flex gap-5 items-center bg-transparent absolute bottom-0 left-0 w-full h-14 px-6 box-shadow-top">
                    <BiSolidVolumeFull
                        size={24}
