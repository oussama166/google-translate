...
const TextTranslate = ({ isDisable, isDone, takeText, output, translateFiled, SetLang }) => {
    ...
    // Read text transformed
    const readText = () => {
        const data = document.querySelector('textarea').value
        responsiveVoice.speak(`${(translateFiled == true) ? output : data}?}`, `${SetLang.rego} Female`, { rate: 1 });
    }
